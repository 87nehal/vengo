...
`vengo config` prints the resolved local configuration with secrets redacted. `vengo deps` prints a dependency graph from a `vengo-deps.json` file generated by an app.
